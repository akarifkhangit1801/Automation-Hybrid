...
public class BaseClass {
	...
	public void setup(String os, String br) throws IOException
	{
		...
		log=LogManager.getLogger(this.getClass());  //Log4j
	...
	public String randomeString()
	{
        RandomStringGenerator stringGenerator = new RandomStringGenerator.Builder()
                ...
                .withinRange('A', 'Z')
                .get();
        String randomString = stringGenerator.generate(8); // 8 letters
	...
	public String randomeNumber()
	{
	     RandomStringGenerator numberGenerator = new RandomStringGenerator.Builder()
	                .withinRange('0', '9')
	                .get();
	     String randomNumbers = numberGenerator.generate(6); // 6 digits
	...
	public String randomAlphaNumeric()
	{
		 RandomStringGenerator stringGenerator = new RandomStringGenerator.Builder()
	                ...
	                .withinRange('A', 'Z')
	                .get(); 
		String str = stringGenerator.generate(3);
		
		RandomStringGenerator numberGenerator = new RandomStringGenerator.Builder()
                .withinRange('0', '9')
                .get();
		String num = numberGenerator.generate(3);
